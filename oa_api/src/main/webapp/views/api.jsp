...
<html ng-app="telemedApiApp">
	<head>
		...
		<title>lingdian-api</title>
		<link rel="stylesheet" media="screen" href="manage/plugins/bootstrap-3.0.0/css/bootstrap.min.css" />
		<link rel="stylesheet" media="screen" href="./resources/site/site.css" />
		<script src="manage/plugins/jquery-2.0.3.js"></script>
		<script src="manage/plugins/bootstrap-3.0.0/js/bootstrap.js"></script>
		<script src="manage/plugins/angular-1.2.19/angular.js"></script>
