...
public class MailUtil {
	...
	public static void sendMail(String content, String email)  throws MessagingException {
        ...
        // 访问SMTP服务时需要提供的密码
        props.put("mail.password", "111111");
	...
	public static void main(String[] args) {
		...
		String[] fj1 = new String[]{"F:\\Material\\image\\1.txt","F:\\Material\\image\\1.doc"};
		String[] fj2 = new String[]{"ms1","ms2"};
		String[] fj3 = new String[]{"name1","name2"};
		htmlsend("smtp.163.com", true, true, "zy135185@163.com", "111111",
