...
* 流程日志表
*/
public class CoreFlowLog extends BaseEntity {
	...
	*创建日期
	*/
	private Date crflwCdate;

	/**
	*修改日期
	*/
	private Date crflwUdate;
	...
	*/
	...
	public void setCrflwUnid(Integer crflwUnid) {
		this.crflwUnid = crflwUnid;
	}

	public Integer getCrflwUnid( ) {
		return crflwUnid;
	}
	...
	public void setCrflwType(String crflwType) {
		this.crflwType = crflwType;
	}

	public String getCrflwType( ) {
		return crflwType;
	}
	...
	public void setCrflwCdate(Date crflwCdate) {
		this.crflwCdate = crflwCdate;
	}

	public Date getCrflwCdate( ) {
		return crflwCdate;
	}

	public void setCrflwUdate(Date crflwUdate) {
		this.crflwUdate = crflwUdate;
	}

	public Date getCrflwUdate( ) {
		return crflwUdate;
	}
	...
	public void convertFlowToFlowLog(Object poObj) {
		if (null == poObj) {
			return;
		}
		...
		try {
			...
			this.crflwUnid = null;
			this.crflwUuid = RandomUtil.generateString(16);
